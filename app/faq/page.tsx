      ...
      <section className="mb-8">          
        <div className="space-y-6">
          <FAQItem 
            ...
            answer={<><p className="text-lg leading-relaxed">
          ...
          <FAQItem 
            ...
            answer={<><p>No, Panglish is for now a linguistic thought experiment. It's not meant to be spoken but rather to illustrate English's Germanic foundations and how borrowing has shaped modern English. However, you can choose to write in Panglish if you like ... I use it for my <a href="https://t.me/s/jonchius" target="_blank">poetry</a>!</p><p>Maybe one day, people will speak in a way similar to Panglish, depending on how the culture rolls!</p></>}
          />
